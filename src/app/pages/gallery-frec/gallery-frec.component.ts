...
@Component({
  selector: 'app-gallery-frec',
  templateUrl: './gallery-frec.component.html',
  styleUrls: ['./gallery-frec.component.scss'],
  animations: [
    trigger('photoState', [
      state('move', style({
...
export class GalleryFrecComponent implements OnInit {
